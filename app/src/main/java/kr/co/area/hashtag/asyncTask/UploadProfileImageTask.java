...
public class UploadProfileImageTask extends AsyncTask<Object, Void, String> {
    ...
    public UploadProfileImageTask(Activity activity) {
        this.activity = activity;
        context = activity.getApplicationContext();
    }

    @Override
    protected String doInBackground(Object... objects) { // 0 : bmp 이미지파일 , 1 : USER ID
        Bitmap bitmap = (Bitmap) objects[0];
        String userID = (String) objects[1];
        attachmentFileName = userID + ".jpg";
        try {
            ...
            request.writeBytes("upload_my_image" + this.crlf);
            request.flush();
